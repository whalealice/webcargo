		...
		<div class="payment_wrap">
            ...
            <ul class="order_list">
                <li class="item_list" v-for="item in data">
                    ...
                    <p class="address">
                        <span class="end_address two_line">收货地：{{item.send_address}}</span>
                        <span class="two_line">发货地：{{item.receive_address}}</span>
                    </p>
                    <p>
                    ...
                    <p class="price">
                        ...
                        <span class="two_line">总价:<br/>{{item.freight_total_price}}</span>
                    </p>
                    <p>
